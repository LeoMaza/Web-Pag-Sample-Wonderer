...
try{
    ...
    $subject = "Correo desde WONDERER";
    $mensa = $_POST['mensaje'];
    $host = "smtp.gmail.com";
    $port = "587";
    $SMTPAuth = "login";
    $SMTPSecure = "tls";
    $username = "cga042pruebas@gmail.com";                 //AQUÍ VA EL CORREO RECEPTOR DEL ENVIO DE MENSAJE
    $password = "holapruebascga";                //AQUÍ VA LA PASSWORD DEL CORREO INDICADO ARRIBA

    $mail = new PHPMailer\PHPMailer\PHPMailer();
    $mail->isSMTP();
    $mail->SMTPDebug = 1;   //"1" EJECUTA DEBUG EN PANTALLA, "0" PARA NO EJECUTAR DEBUG
    $mail->Host = $host;
    $mail->Port = $port;
